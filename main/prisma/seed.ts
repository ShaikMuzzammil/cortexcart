...
const PRODUCTS: P[] = [
  ...
  {n:'ChairPad Lumbar Support',sku:'CHR-LMB-029',c:'gaming',p:59,cp:79,s:60,r:4.6,rc:1540,f:false,d:false,desc:'Memory foam lumbar pillow, adjustable strap, gaming chair fit.',img:'https://images.unsplash.com/photo-1612372606404-0ab33e7187ee?w=600',t:['lumbar','support','chair']},
  ...
  {n:'RoboVac X8 Hybrid',sku:'ROB-VAC-038',c:'home',p:299,cp:379,s:12,r:4.7,rc:2890,f:true,d:true,desc:'LiDAR robot vacuum + mop, 6000Pa suction, auto-empty base.',img:'https://images.unsplash.com/photo-1647940990395-967898eb0d65?w=600',t:['robot-vacuum','lidar','mop']},
  ...
  {n:'PolarFleece Zip Hoodie',sku:'POL-HDI-048',c:'fashion',p:89,cp:119,s:35,r:4.6,rc:1560,f:false,d:true,desc:'Heavyweight 340gsm fleece, full-zip, kangaroo pocket.',img:'https://images.unsplash.com/photo-1512400930990-e0bc0bd809df?w=600',t:['hoodie','fleece','winter']},
  ...
  {n:'CityTote Canvas Bag XL',sku:'CTY-TOT-051',c:'fashion',p:49,cp:65,s:70,r:4.4,rc:1340,f:false,d:false,desc:'Heavy canvas, inner laptop sleeve 15", magnetic snap closure.',img:'https://images.unsplash.com/photo-1548863227-3af567fc3b27?w=600',t:['tote','canvas','laptop']},
  ...
  {n:'HydraHero SPF50 Moisturizer',sku:'HYD-MST-057',c:'beauty',p:49,cp:65,s:60,r:4.7,rc:4310,f:true,d:false,desc:'SPF50 lightweight moisturizer, hyaluronic acid, fragrance-free.',img:'https://images.unsplash.com/photo-1608068811588-3a67006b7489?w=600',t:['moisturizer','spf','hydrating']},
  ...
  {n:'LipLux Long-Wear Set 12',sku:'LPL-LWS-060',c:'beauty',p:45,cp:59,s:55,r:4.6,rc:1890,f:false,d:false,desc:'12-shade long-wear liquid lipstick set, matte finish, 24h.',img:'https://images.unsplash.com/photo-1625093742435-6fa192b6fb10?w=600',t:['lipstick','makeup','long-wear']},
  ...
  {n:'ScentLab Perfume Sampler 10',sku:'SCN-PRF-063',c:'beauty',p:59,cp:79,s:45,r:4.6,rc:2100,f:true,d:false,desc:'10 x 2ml designer-inspired perfume collection, gift box.',img:'https://images.unsplash.com/photo-1541643600914-78b084683702?w=600',t:['perfume','fragrance','sampler']},

  // ── SPORTS (10) ───────────────────────────────────────────────────
  {n:'IronGrip Adjustable Dumbbells',sku:'IRN-DBL-064',c:'sports',p:249,cp:329,s:14,r:4.8,rc:4320,f:true,d:true,desc:'5-52.5lb adjustable dumbbell set, space-saving, quick-lock.',img:'https://images.unsplash.com/photo-1638536532686-d610adfc8e5c?w=600',t:['dumbbells','weights','fitness']},
  {n:'FlexBand Resistance Kit Pro',sku:'FLX-BND-065',c:'sports',p:39,cp:55,s:150,r:4.6,rc:7890,f:false,d:false,desc:'6-level latex resistance bands, handles + door anchor kit.',img:'https://images.unsplash.com/photo-1630703178182-f69a2d617ddb?w=600',t:['resistance-bands','fitness','home-gym']},
  {n:'PaceTrack GPS Running Watch',sku:'PCE-WCH-066',c:'sports',p:279,cp:349,s:16,r:4.7,rc:2560,f:true,d:false,desc:'GPS running watch, VO2 max, 20h battery, heart rate.',img:'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=600',t:['running-watch','gps','vo2max']},
  ...
  {n:'NeoSurf Foam Roller PRO',sku:'NEO-FMR-068',c:'sports',p:35,cp:49,s:120,r:4.5,rc:3450,f:false,d:false,desc:'High-density vibrating foam roller, 3 speeds, USB-C charge.',img:'https://images.unsplash.com/photo-1627257058769-0a99529e4312?w=600',t:['foam-roller','recovery','vibration']},
  {n:'PullPod Door Pull-Up Bar',sku:'PLL-BAR-069',c:'sports',p:49,cp:65,s:90,r:4.6,rc:5670,f:false,d:false,desc:'No-drill door pull-up bar, 300lb capacity, multi-grip.',img:'https://images.unsplash.com/photo-1558611848-73f7eb4001a1?w=600',t:['pull-up-bar','home-gym','strength']},
  {n:'SpeedJump Digital Rope',sku:'SPD-JMP-070',c:'sports',p:29,cp:39,s:200,r:4.5,rc:4320,f:false,d:false,desc:'Digital jump rope with calorie counter, LED speed display.',img:'https://images.unsplash.com/photo-1516876345887-6dd74f80787a?w=600',t:['jump-rope','cardio','fitness']},
  {n:'ComprePro Knee Sleeves',sku:'CMP-KNE-071',c:'sports',p:49,cp:65,s:80,r:4.7,rc:2890,f:false,d:true,desc:'7mm neoprene knee sleeves pair, powerlifting, thermal support.',img:'https://images.unsplash.com/photo-1627257058769-0a99529e4312?w=600',t:['knee-sleeves','powerlifting','support']},
  ...
  {n:'YogaMat Alignment Pro 6mm',sku:'YGA-MAT-073',c:'sports',p:79,cp:99,s:70,r:4.7,rc:3210,f:false,d:true,desc:'6mm TPE yoga mat, alignment lines, eco-friendly, carry strap.',img:'https://images.unsplash.com/photo-1646239646963-b0b9be56d6b5?w=600',t:['yoga','mat','eco']},

  // ── OFFICE (8) ────────────────────────────────────────────────────
  {n:'ErgoChair Pro Lumbar',sku:'ERG-CHR-074',c:'office',p:449,cp:599,s:10,r:4.8,rc:3450,f:true,d:false,desc:'Ergonomic mesh chair, adjustable lumbar, 4D armrests.',img:'https://images.unsplash.com/photo-1612372606404-0ab33e7187ee?w=600',t:['chair','ergonomic','lumbar']},
  ...
  {n:'NapShade Sleep Mask Pro',sku:'NAP-MSK-096',c:'travel',p:25,cp:35,s:300,r:4.6,rc:7890,f:false,d:false,desc:'3D contoured sleep mask, zero light, memory foam nose bridge.',img:'https://images.unsplash.com/photo-1553531889-56cc480ac5cb?w=600',t:['sleep-mask','blackout','travel']},
  {n:'LockSafe TSA Combo Padlock',sku:'LCK-PDL-097',c:'travel',p:19,cp:29,s:500,r:4.7,rc:9870,f:false,d:false,desc:'TSA-approved combination padlock, 4-dial, cable included.',img:'https://images.unsplash.com/photo-1618588845382-4267677cfc11?w=600',t:['padlock','tsa','security']},
  ...
  {n:'PixelView 4K Monitor 32"',sku:'CMP-MON-214',c:'computing',p:549,cp:699,s:14,r:4.8,rc:1120,f:true,d:true,desc:'32" 4K IPS monitor, 99% sRGB, USB-C 90W power delivery, height-adjustable.',img:'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=600',t:['monitor','4k','usb-c']},
  ...
  {n:'FlexRiser Aluminum Laptop Stand',sku:'CMP-ACC-216',c:'computing',p:45,cp:59,s:90,r:4.6,rc:3210,f:false,d:false,desc:'Foldable aluminum laptop stand, 7 angles, heat-dissipating design.',img:'https://images.unsplash.com/photo-1593640495253-23196b27a87f?w=600',t:['laptop-stand','aluminum','ergonomic']},
  ...
  {n:'SignalBoost Cellular Amplifier',sku:'ELC-NET-224',c:'electronics',p:299,cp:379,s:10,r:4.5,rc:320,f:false,d:false,desc:'Boosts 4G/5G signal up to 4000 sq ft, supports all major carriers.',img:'https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=600',t:['signal-booster','cellular','5g']},
  ...
  {n:'ChargeDock 3-in-1 Wireless Stand',sku:'ELC-CHG-226',c:'electronics',p:79,cp:99,s:60,r:4.7,rc:1670,f:true,d:false,desc:'15W MagSafe-compatible charging stand for phone, watch and earbuds.',img:'https://images.unsplash.com/photo-1698314440014-3badb1e9c938?w=600',t:['wireless-charger','magsafe','stand']},
  {n:'LinkBridge Smart Home Hub Pro',sku:'ELC-HOM-227',c:'electronics',p:99,cp:129,s:38,r:4.6,rc:1230,f:false,d:false,desc:'Matter/Zigbee/Z-Wave hub, unifies all your smart devices in one app.',img:'https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=600',t:['smart-hub','matter','automation']},
  ...
  {n:'NanoBot Robotic Vacuum X9',sku:'TCH-ROB-306',c:'tech',p:549,cp:699,s:19,r:4.8,rc:3340,f:true,d:false,desc:'LiDAR mapping robot vacuum + mop, 180min runtime, auto-empty base.',img:'https://images.unsplash.com/photo-1653990480360-31a12ce9723e?w=600',t:['robot-vacuum','lidar','smart-home']},
  ...
  {n:'LuxeSoft Cashmere Blend Sweater',sku:'FSH-SWR-341',c:'fashion',p:129,cp:179,s:28,r:4.8,rc:1890,f:true,d:true,desc:'70% cashmere blend crew-neck sweater, hand-wash, 6 rich colors, XS-XXL.',img:'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=600',t:['cashmere','sweater','luxury']},
  ...
  {n:'AeroPump Smart Jump Rope',sku:'SPT-JRP-360',c:'sports',p:39,cp:55,s:90,r:4.6,rc:4560,f:false,d:false,desc:'Smart digital jump rope, calorie counter, 30-day rope included, phone-free.',img:'https://images.unsplash.com/photo-1516876345887-6dd74f80787a?w=600',t:['jump-rope','smart','cardio']},
  {n:'FlexPull Resistance Band Set 11pc',sku:'SPT-RST-361',c:'sports',p:34,cp:49,s:150,r:4.7,rc:8900,f:false,d:false,desc:'11-piece latex resistance band set, door anchor, handles, ankle straps, 10-150lb.',img:'https://images.unsplash.com/photo-1630703178182-f69a2d617ddb?w=600',t:['resistance-bands','workout','home-gym']},
  ...
  {n:'PowerBlock Elite Dumbbell 50lb',sku:'SPT-DBL-365',c:'sports',p:349,cp:449,s:12,r:4.8,rc:2340,f:true,d:true,desc:'Adjustable dumbbell set, replaces 28 dumbbells, 2.5-50lb each, selector pin.',img:'https://images.unsplash.com/photo-1638536534984-0d98ccdb6af5?w=600',t:['dumbbell','adjustable','strength']},
  ...
  {n:'CyclePro Cadence + Speed Sensor',sku:'SPT-CYC-367',c:'sports',p:49,cp:69,s:55,r:4.5,rc:1890,f:false,d:false,desc:'ANT+/Bluetooth dual speed + cadence sensor, pairs with Garmin/Wahoo/Zwift.',img:'https://images.unsplash.com/photo-1558611848-73f7eb4001a1?w=600',t:['cycling','cadence','sensor']},
  ...
  {n:'PageLite LED Book Light Rechargeable',sku:'BOK-LGT-413',c:'books',p:19,cp:29,s:200,r:4.5,rc:7890,f:false,d:false,desc:'Rechargeable LED book light, 3 brightness + 3 color temps, flexible neck, clip-on.',img:'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=600',t:['book-light','led','rechargeable']},
  ...
  {n:'HiddenCam Nanny Spy Detector',sku:'ELC-SPY-442',c:'electronics',p:49,cp:69,s:67,r:4.4,rc:2340,f:false,d:false,desc:'RF/lens spy camera detector, laser + RF detection, 10m range, USB rechargeable.',img:'https://images.unsplash.com/photo-1519817650390-64a93db51149?w=600',t:['detector','security','privacy']},
  ...
  {n:'SmartSensor CO + Gas Alarm Combo',sku:'ELC-ALM-445',c:'electronics',p:39,cp:55,s:89,r:4.6,rc:3450,f:false,d:true,desc:'Combo CO + natural gas detector, 85dB alarm, 5-year sensor life, plug-in + battery.',img:'https://images.unsplash.com/photo-1519817650390-64a93db51149?w=600',t:['co-detector','gas','safety']},
  {n:'TeleCast HDMI to SDI Converter',sku:'ELC-CNV-446',c:'electronics',p:79,cp:109,s:22,r:4.5,rc:560,f:false,d:false,desc:'HDMI to 3G-SDI broadcast converter, 1080p60, mini-DIN BNC, powered.',img:'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600',t:['hdmi','sdi','broadcast']},
  ...
  {n:'AmpShield Guitar Amplifier 15W',sku:'AUD-AMP-454',c:'audio',p:149,cp:199,s:18,r:4.6,rc:890,f:false,d:false,desc:'15W solid-state guitar amp, 8" speaker, overdrive, reverb, headphone out, USB.',img:'https://images.unsplash.com/photo-1502798985865-1ab60332f46c?w=600',t:['guitar-amp','15w','electric']},
