...
const PRODUCTS: P[] = [
  ...
  {n:'NanoBot Robotic Vacuum X9',sku:'TCH-ROB-306',c:'tech',p:549,cp:699,s:19,r:4.8,rc:3340,f:true,d:false,desc:'LiDAR mapping robot vacuum + mop, 180min runtime, auto-empty base.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['robot-vacuum','lidar','smart-home']},
  {n:'QuantumCharge Wireless Mat',sku:'TCH-CHG-307',c:'tech',p:59,cp:79,s:90,r:4.5,rc:4560,f:false,d:false,desc:'15W Qi2 wireless charging mat, 3-device simultaneous, LED indicator.',img:'https://images.unsplash.com/photo-1586495777744-4e6232bf2fb7?w=600',t:['wireless-charger','qi2','qi']},
  {n:'SmartLock Pro Fingerprint Deadbolt',sku:'TCH-LOK-308',c:'tech',p:189,cp:249,s:27,r:4.7,rc:1120,f:false,d:true,desc:'Fingerprint + PIN + app smart deadbolt, 100 fingerprints, auto-lock.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['smart-lock','fingerprint','security']},
  ...
  {n:'ProStrike Mechanical Keyboard RGB',sku:'GAM-KBD-320',c:'gaming',p:149,cp:189,s:42,r:4.8,rc:5670,f:true,d:false,desc:'Full-size mechanical gaming keyboard, optical switches, per-key RGB, USB passthrough.',img:'https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=600',t:['keyboard','mechanical','rgb']},
  ...
  {n:'AirPure HEPA Air Purifier H13',sku:'HOM-AIR-330',c:'home',p:189,cp:249,s:28,r:4.8,rc:4560,f:true,d:true,desc:'True HEPA H13 air purifier, 600 sq ft, auto mode, PM2.5 sensor, ultra-quiet.',img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600',t:['air-purifier','hepa','smart-home']},
  {n:'ChromaCast LED Strip 10m Kit',sku:'HOM-LED-331',c:'home',p:49,cp:69,s:150,r:4.5,rc:8900,f:false,d:false,desc:'10m Wi-Fi RGBIC LED strip, music sync, app control, works with Alexa/Google.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['led-strip','rgb','smart-home']},
  ...
  {n:'EchoClean Ultrasonic Cleaner',sku:'HOM-CLN-333',c:'home',p:59,cp:79,s:67,r:4.5,rc:3450,f:false,d:true,desc:'600ml ultrasonic cleaner, 40kHz, timer, for jewelry, glasses, dental retainers.',img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600',t:['ultrasonic','cleaner','jewelry']},
  ...
  {n:'StormShield Doorbell Camera 2K',sku:'HOM-CAM-336',c:'home',p:99,cp:139,s:38,r:4.6,rc:3120,f:true,d:true,desc:'2K wired video doorbell, color night vision, two-way audio, package detection.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['doorbell','camera','security']},
  {n:'HydroWarm Smart Radiator Valve',sku:'HOM-HVR-337',c:'home',p:49,cp:69,s:67,r:4.5,rc:2890,f:false,d:false,desc:'Smart TRV radiator valve, weekly scheduling, open-window detection, Zigbee.',img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600',t:['radiator','smart-home','heating']},
  ...
  {n:'LashLift Pro Heated Eyelash Curler',sku:'BTY-LSH-352',c:'beauty',p:29,cp:39,s:120,r:4.4,rc:4560,f:false,d:false,desc:'Heated eyelash curler, 3 temperature settings, 10s heat-up, cordless.',img:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600',t:['eyelash','heated','makeup']},
  ...
  {n:'CyclePro Cadence + Speed Sensor',sku:'SPT-CYC-367',c:'sports',p:49,cp:69,s:55,r:4.5,rc:1890,f:false,d:false,desc:'ANT+/Bluetooth dual speed + cadence sensor, pairs with Garmin/Wahoo/Zwift.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['cycling','cadence','sensor']},
  ...
  {n:'LumiDesk Smart Desk Lamp',sku:'OFC-LMP-374',c:'office',p:79,cp:99,s:45,r:4.6,rc:2890,f:true,d:false,desc:'Smart LED desk lamp, 1000lm, color temperature 2700-6500K, 15W USB-A charging.',img:'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=600',t:['desk-lamp','smart','usb-charging']},
  ...
  {n:'AcousticPro Soundhole Pickup',sku:'MUS-PKP-381',c:'music',p:49,cp:69,s:55,r:4.5,rc:890,f:false,d:false,desc:'Passive soundhole acoustic guitar pickup, volume control, strap pin, plug-in.',img:'https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=600',t:['pickup','acoustic','guitar']},
  {n:'BeatBox Drum Pad 16-Pad Controller',sku:'MUS-DRM-382',c:'music',p:129,cp:169,s:28,r:4.6,rc:1560,f:false,d:true,desc:'16 velocity-sensitive RGB pads, 8 faders, transport controls, USB bus-powered.',img:'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=600',t:['drum-pad','beatmaking','controller']},
  ...
  {n:'RecordLink USB Audio Interface 2-in',sku:'MUS-AIF-384',c:'music',p:99,cp:139,s:33,r:4.8,rc:2340,f:true,d:false,desc:'2-in/2-out 24-bit/192kHz USB audio interface, phantom power, loopback, bus-powered.',img:'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=600',t:['audio-interface','recording','usb']},
  ...
  {n:'CastIron Chef 12" Skillet',sku:'KIT-SKL-391',c:'kitchen',p:59,cp:79,s:78,r:4.9,rc:7890,f:false,d:false,desc:'Pre-seasoned cast iron skillet, 12", helper handle, oven-safe to 500°F, lifetime.',img:'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600',t:['cast-iron','skillet','cookware']},
  {n:'FrothMaster Milk Frother 4-in-1',sku:'KIT-FRT-392',c:'kitchen',p:39,cp:55,s:120,r:4.6,rc:6780,f:false,d:false,desc:'Electric milk frother, hot/cold foam, hot milk, stand included, 400ml capacity.',img:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600',t:['frother','milk','coffee']},
  {n:'SousVide Precision Cooker 1200W',sku:'KIT-SVD-393',c:'kitchen',p:119,cp:159,s:27,r:4.7,rc:2340,f:true,d:true,desc:'1200W sous vide immersion circulator, ±0.1°C precision, 20L max, WiFi control.',img:'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600',t:['sous-vide','precision','cooking']},
  {n:'SpiceVault Magnetic Jar Set 24pc',sku:'KIT-SPC-394',c:'kitchen',p:49,cp:69,s:89,r:4.5,rc:4560,f:false,d:false,desc:'24 magnetic airtight spice jars, labels included, fridge/wall mountable, clear glass.',img:'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600',t:['spice-jars','magnetic','kitchen']},
  {n:'BrewMaster Cold Brew Coffee Maker',sku:'KIT-CBR-395',c:'kitchen',p:45,cp:65,s:100,r:4.6,rc:3450,f:false,d:false,desc:'1L cold brew coffee maker, fine mesh filter, borosilicate glass, dishwasher safe.',img:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600',t:['cold-brew','coffee','glass']},
  {n:'PizzaStone Cordierite Baking Kit',sku:'KIT-PIZ-396',c:'kitchen',p:39,cp:55,s:67,r:4.7,rc:2890,f:false,d:true,desc:'Cordierite pizza stone 14", wooden peel, pizza cutter bundle — oven/grill safe.',img:'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600',t:['pizza','baking','stone']},
  ...
  {n:'SolarCharge 20W Foldable Panel',sku:'TRV-SOL-403',c:'travel',p:89,cp:119,s:28,r:4.5,rc:1230,f:false,d:false,desc:'20W foldable solar charger panel, dual USB-C + USB-A, IP65, 1.8kg, camping.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['solar','charger','camping']},
  ...
  {n:'PageLite LED Book Light Rechargeable',sku:'BOK-LGT-413',c:'books',p:19,cp:29,s:200,r:4.5,rc:7890,f:false,d:false,desc:'Rechargeable LED book light, 3 brightness + 3 color temps, flexible neck, clip-on.',img:'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=600',t:['book-light','led','rechargeable']},
  ...
  {n:'RunIQ GPS Running Watch',sku:'WER-GPS-420',c:'wearables',p:179,cp:229,s:28,r:4.7,rc:2340,f:true,d:true,desc:'Dedicated GPS running watch, auto-lap, heart rate, VO2max, 20h battery, 5ATM.',img:'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600',t:['running-watch','gps','fitness']},
  ...
  {n:'FlexGlove Smart Rehabilitation Glove',sku:'WER-GLV-423',c:'wearables',p:159,cp:209,s:14,r:4.3,rc:340,f:false,d:false,desc:'Smart compression glove, finger tracking, vibration therapy, arthritis relief.',img:'https://images.unsplash.com/photo-1434493789847-2f02dc6ca35d?w=600',t:['glove','smart','rehabilitation']},
  {n:'SolarPulse UV Index Watch',sku:'WER-UV-424',c:'wearables',p:89,cp:119,s:33,r:4.4,rc:780,f:false,d:false,desc:'Analog watch with UV index display, solar charge backup, WR50, unisex.',img:'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600',t:['uv-watch','solar','outdoor']},
  ...
  {n:'VitaBand Medical Alert Smart Band',sku:'WER-MDL-426',c:'wearables',p:59,cp:79,s:55,r:4.6,rc:1890,f:false,d:false,desc:'Medical alert smart band, emergency SOS, fall detection, heart rate, IP68, elderly.',img:'https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=600',t:['medical-alert','sos','elderly']},
  ...
  {n:'PixelPen 2 Stylus for Tablets',sku:'CMP-STY-431',c:'computing',p:89,cp:119,s:28,r:4.6,rc:1890,f:false,d:false,desc:'4096-level pressure stylus, palm rejection, tilt support, USB-C charge, 10hr.',img:'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=600',t:['stylus','tablet','drawing']},
  ...
  {n:'NetGuard WiFi 6 Range Extender',sku:'CMP-EXT-436',c:'computing',p:69,cp:89,s:55,r:4.5,rc:2890,f:false,d:true,desc:'WiFi 6 AX3000 range extender, ethernet port, 4 antennas, covers 2500 sq ft.',img:'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=600',t:['wifi-extender','wifi6','networking']},
  ...
  {n:'HiddenCam Nanny Spy Detector',sku:'ELC-SPY-442',c:'electronics',p:49,cp:69,s:67,r:4.4,rc:2340,f:false,d:false,desc:'RF/lens spy camera detector, laser + RF detection, 10m range, USB rechargeable.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['detector','security','privacy']},
  ...
  {n:'StepDown 220V to 110V Converter 2000W',sku:'ELC-CNV-444',c:'electronics',p:59,cp:79,s:45,r:4.4,rc:1560,f:false,d:false,desc:'2000W voltage converter 220V to 110V, CE certified, thermal cutoff, indicator.',img:'https://images.unsplash.com/photo-1586495777744-4e6232bf2fb7?w=600',t:['converter','voltage','travel']},
  {n:'SmartSensor CO + Gas Alarm Combo',sku:'ELC-ALM-445',c:'electronics',p:39,cp:55,s:89,r:4.6,rc:3450,f:false,d:true,desc:'Combo CO + natural gas detector, 85dB alarm, 5-year sensor life, plug-in + battery.',img:'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=600',t:['co-detector','gas','safety']},
  {n:'TeleCast HDMI to SDI Converter',sku:'ELC-CNV-446',c:'electronics',p:79,cp:109,s:22,r:4.5,rc:560,f:false,d:false,desc:'HDMI to 3G-SDI broadcast converter, 1080p60, mini-DIN BNC, powered.',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',t:['hdmi','sdi','broadcast']},
  ...
  {n:'AmpShield Guitar Amplifier 15W',sku:'AUD-AMP-454',c:'audio',p:149,cp:199,s:18,r:4.6,rc:890,f:false,d:false,desc:'15W solid-state guitar amp, 8" speaker, overdrive, reverb, headphone out, USB.',img:'https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=600',t:['guitar-amp','15w','electric']},
  {n:'PodcastKit USB Condenser Mic Bundle',sku:'AUD-POD-455',c:'audio',p:99,cp:139,s:33,r:4.8,rc:3120,f:true,d:false,desc:'USB condenser mic + boom arm + pop filter + shock mount podcast bundle.',img:'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=600',t:['microphone','podcast','usb']},
  ...
  {n:'ColorChart X-Rite Passport 2',sku:'PHO-CLR-464',c:'photography',p:99,cp:129,s:18,r:4.7,rc:670,f:false,d:false,desc:'Color calibration passport, 24 patches, 2 grey balance targets, software included.',img:'https://images.unsplash.com/photo-1606986628253-05620e9a4e22?w=600',t:['color-checker','calibration','passport']},
  ...
  {n:'SpaDay Dog Blowing Dryer 2400W',sku:'PET-DRY-470',c:'pets',p:69,cp:89,s:33,r:4.5,rc:1560,f:false,d:true,desc:'2400W two-speed pet blowing dryer, 3 nozzles, low-noise, stainless heating.',img:'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=600',t:['pet-dryer','grooming','dog']},
  {n:'AquaFresh Reverse Osmosis Pet Water Purifier',sku:'PET-WTR-471',c:'pets',p:129,cp:169,s:14,r:4.6,rc:780,f:false,d:false,desc:'Countertop RO pet water purifier, 5-stage filter, removes 99% contaminants, 2L/hr.',img:'https://images.unsplash.com/photo-1548767797-d8c844163c4a?w=600',t:['water-purifier','ro','pet-health']},
  {n:'MicroChip GPS Tracker Pet Tag',sku:'PET-GPS-472',c:'pets',p:39,cp:55,s:89,r:4.5,rc:3450,f:true,d:false,desc:'Lightweight GPS pet tracker tag, 4G LTE, 7-day battery, geo-fence alerts, app.',img:'https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=600',t:['gps-tracker','pet','cat-dog']},
  {n:'ScratchSave Corner Sofa Protector',sku:'PET-SCR-473',c:'pets',p:29,cp:39,s:150,r:4.4,rc:4560,f:false,d:false,desc:'Set of 4 clear scratch guard panels for sofa corners, peel-stick, 17"×12".',img:'https://images.unsplash.com/photo-1574144611937-0df059b5ef3e?w=600',t:['scratch-guard','cat','furniture']},
  {n:'OrthoFoam Orthopedic Dog Bed XL',sku:'PET-BED-474',c:'pets',p:89,cp:119,s:22,r:4.7,rc:2340,f:false,d:true,desc:'XL orthopedic memory foam dog bed, waterproof liner, removable cover, 40"×30".',img:'https://images.unsplash.com/photo-1548767797-d8c844163c4a?w=600',t:['dog-bed','orthopedic','xl']},
  {n:'BirdWatch Smart Feeder Camera',sku:'PET-BRD-475',c:'pets',p:119,cp:159,f:false,d:false,s:18,r:4.6,rc:1230,desc:'Smart bird feeder with 1080P camera, AI bird ID, solar powered, Wi-Fi, app.',img:'https://images.unsplash.com/photo-1591946614720-90a588f04dac?w=600',t:['bird-feeder','camera','solar']},
  {n:'PetCalm Anxiety Vest Thunder Jacket',sku:'PET-ANX-476',c:'pets',p:39,cp:55,s:78,r:4.5,rc:3120,f:false,d:false,desc:'Calming pressure vest for dogs, drug-free anxiety relief, XS-XL, 8 colors.',img:'https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=600',t:['anxiety-vest','dog','calming']},
]
