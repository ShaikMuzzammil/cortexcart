...
export async function sendLoginSuccessEmail(to: string, data: { name: string }) {
  return sendMail({
    ...
    html: wrap(`
      ...
      <div class="body">
        <div class="highlight">
          <p style="margin:0;font-size:16px;font-weight:800;color:#fff;">You're now signed in ✅</p>
          <p style="margin:6px 0 0;font-size:13px;color:#8896b3;">All your orders, wishlist, and account settings are ready for you.</p>
        </div>
        <div class="card">
          <div class="section-title">Quick Links</div>
          <div class="info-grid" style="margin-top:10px;">
            <a href="${APP}/products" style="text-decoration:none;display:block;background:#0e1220;border:1px solid #1e2640;border-radius:10px;padding:14px;text-align:center;">
              <div style="font-size:22px;margin-bottom:6px;">🛍️</div>
              <div style="font-size:12px;font-weight:700;color:#fff;">Shop Now</div>
              <div style="font-size:11px;color:#5a6a8a;">Browse products</div>
            </a>
            <a href="${APP}/account?tab=orders" style="text-decoration:none;display:block;background:#0e1220;border:1px solid #1e2640;border-radius:10px;padding:14px;text-align:center;">
              <div style="font-size:22px;margin-bottom:6px;">📦</div>
              <div style="font-size:12px;font-weight:700;color:#fff;">My Orders</div>
              <div style="font-size:11px;color:#5a6a8a;">Track & view orders</div>
            </a>
            <a href="${APP}/wishlist" style="text-decoration:none;display:block;background:#0e1220;border:1px solid #1e2640;border-radius:10px;padding:14px;text-align:center;">
              <div style="font-size:22px;margin-bottom:6px;">❤️</div>
              <div style="font-size:12px;font-weight:700;color:#fff;">Wishlist</div>
              <div style="font-size:11px;color:#5a6a8a;">Saved items</div>
            </a>
            <a href="${APP}/contact" style="text-decoration:none;display:block;background:#0e1220;border:1px solid #1e2640;border-radius:10px;padding:14px;text-align:center;">
              <div style="font-size:22px;margin-bottom:6px;">💬</div>
              <div style="font-size:12px;font-weight:700;color:#fff;">Support</div>
              <div style="font-size:11px;color:#5a6a8a;">Get help anytime</div>
            </a>
          </div>
        </div>
        <div style="text-align:center;margin-top:20px;">
          <a href="${APP}/products" class="btn">Start Exploring ⚡</a>
        </div>
        <p style="text-align:center;font-size:11px;color:#3a4a6a;margin-top:16px;">
          Not you? <a href="${APP}/contact" style="color:#10d988;">Contact support immediately</a>
        </p>
      </div>`
    )
  })
...
export async function sendOrderStatusUpdateEmail(to: string, data: {
  customerName: string
  orderNumber: string
  orderId: string
  newStatus: string
  ...
  return sendMail({
    ...
    html: wrap(`
      ...
      <div class="body">
        <p style="color:#c0cfe8;font-size:14px;line-height:1.7;">Hi <strong style="color:#fff;">${data.customerName}</strong>, here's an update on your order.</p>
        <div class="card">
          ...
          <div class="row"><span class="label">New Status</span><span class="badge">${emoji} ${label}</span></div>
          ...
          ${data.notes ? `<div class="row"><span class="label">Note</span><span class="val">${data.notes}</span></div>` : ''}
        </div>
        <div style="text-align:center;margin-top:20px;">
          <a href="${trackUrl}" class="btn">Track Order Live 📍</a>
        </div>
        <p style="text-align:center;font-size:11px;color:#5a6a8a;margin-top:12px;">
          Questions? <a href="${APP}/contact" style="color:#10d988;">Contact our support team</a>
        </p>
      </div>`
    )
  })
